...
import { HEIGHT, ParameterNumber, WIDTH } from '@engine/controller';
import { shortcut } from '@engine/core';
import { AbstractParameterCellControllerWidget } from '../cell_controller.abstract';
let CellNumber = class CellNumber extends AbstractParameterCellControllerWidget {
    constructor() {
        super(...arguments);
        this.props = {
            width: WIDTH,
    ...
    render() {
        ...
        return Object.assign(Object.assign({}, opts), { type: ParameterNumber.xtype, ref: (ref) => {
                this.editor = ref;
...
CellNumber.xtype = 'report.main.table_cell.controller.number';
CellNumber = __decorate([
    shortcut()
], CellNumber);
export { CellNumber };
//# sourceMappingURL=cell_controller.number.js.map