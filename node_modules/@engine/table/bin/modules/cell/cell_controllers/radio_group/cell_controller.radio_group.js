...
import { HEIGHT, ParameterRadioGroup, WIDTH } from '@engine/controller';
...
let CellRadioGroup = class CellRadioGroup extends AbstractParameterCellControllerWidget {
    constructor() {
        super(...arguments);
        this.props = {
            width: WIDTH,
    ...
    render() {
        ...
        return Object.assign(Object.assign({}, opts), { type: ParameterRadioGroup.xtype, ref: (ref) => {
                this.group = ref;
            }, listeners: xlisteners, controlAttrFetcher: fetchCellGroupControlAttr, extraOptsGetter: () => {
                return {
...
CellRadioGroup.xtype = 'report.main.table_cell.controller.radio_group';
CellRadioGroup = __decorate([
    shortcut()
], CellRadioGroup);
export { CellRadioGroup };
//# sourceMappingURL=cell_controller.radio_group.js.map