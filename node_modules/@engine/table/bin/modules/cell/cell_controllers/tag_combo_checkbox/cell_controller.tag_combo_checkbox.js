...
import { HEIGHT, ParameterTagComboCheckboxNext, WIDTH } from '@engine/controller';
...
let CellTagComboCheckbox = class CellTagComboCheckbox extends AbstractParameterCellControllerWidget {
    constructor() {
        super(...arguments);
        this.props = {
            width: WIDTH,
    ...
    render() {
        ...
        return Object.assign(Object.assign({}, opts), { type: ParameterTagComboCheckboxNext.xtype, ref: (ref) => {
                this.combo = ref;
...
CellTagComboCheckbox.xtype = 'report.main.table_cell.controller.tag_combo_checkbox';
CellTagComboCheckbox = __decorate([
    shortcut()
], CellTagComboCheckbox);
export { CellTagComboCheckbox };
//# sourceMappingURL=cell_controller.tag_combo_checkbox.js.map