...
import { HEIGHT, ParameterDatetime, WIDTH } from '@engine/controller';
...
let CellDatetime = class CellDatetime extends AbstractParameterCellControllerWidget {
    constructor() {
        super(...arguments);
        this.props = {
            width: WIDTH,
    ...
    render() {
        ...
        return Object.assign(Object.assign({}, opts), { container: 'body', type: ParameterDatetime.xtype, ref: (ref) => {
                this.combo = ref;
            }, listeners: xlisteners, controlAttrFetcher: fetchCellDatetimeControlAttr, extraOptsGetter: () => {
                return {
...
CellDatetime.xtype = 'report.main.table_cell.controller.datetime';
CellDatetime = __decorate([
    shortcut()
], CellDatetime);
export { CellDatetime };
//# sourceMappingURL=cell_controller.datetime.js.map