...
declare type _constant = <T>(xtype: string, cls: T) => (() => T);
declare type _model = (xtype: string, cls: any) => Function;
declare type _store = (xtype: string, cls: any) => Function;
declare type _service = (xtype: string, cls: any) => Function;
declare type _provider = (xtype: string, cls: any) => Function;
interface _modules {
